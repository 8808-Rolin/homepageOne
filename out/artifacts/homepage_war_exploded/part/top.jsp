...
<body vlink="gray" onload="updatepage('<%=username%>','<%=id%>')">
	<div class="top" >
				<ul class="toplist">
					<li><a href="/index.jsp"><p class="text">主页</p></a></li>
					<li><a href="javascript:alert('收藏夹还未开放');"><p class="text">收藏</p></a></li>
					<li><a href="javascript:alert('资源站还未开放');" ><p class="text">资源站</p></a></li>
					<li><a href="/login.jsp" id="logina"><p class="text" id="login">登录</p></a></li>
					<li><a href="/reg/reg.jsp" id="rega"><p class="text" id="reg">注册</p></a></li>
					<li><a href="/debug"><p class="text">测试网页</p></a></li>
				</ul>
		</div>
